...
-- not sure if this worked because it returned zero rows
SELECT * FROM analytics WHERE min_installs <= 50 and rating != null ORDER BY rating DESC;
...
SELECT COUNT(category) FROM analytics GROUP BY category HAVING COUNT(category) > 300;
