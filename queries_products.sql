...
-- I was encountering a lot of bugs and obstacles so I used the solution
-- for this first problem to make sure my query was not the issue. Otherwise
-- I did not use the solution.
